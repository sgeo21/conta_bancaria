...
1. Clone o repositório do Projeto [Conta Bancária](https://github.com/sgeo21/conta_bancaria) dentro da pasta do *Workspace* do Eclipse/STS

```bash
git clone https://github.com/sgeo21/conta_bancaria
```
...
Para dúvidas, sugestões ou colaborações, entre em contato via GitHub ou abra uma issue!# Java
